...
public:
    ...
    void setupUi(QMainWindow *taodonhang)
    {
        ...
        lblGiatridon->setGeometry(QRect(260, 150, 91, 16));
        QFont font;
        font.setBold(true);
        font.setWeight(75);
        lblGiatridon->setFont(font);
        lblGiatridon->setAlignment(Qt::AlignCenter);
        lblT = new QLabel(groupBox_3);
        lblT->setObjectName(QString::fromUtf8("lblT"));
        lblT->setGeometry(QRect(200, 150, 58, 16));
    ...
    void retranslateUi(QMainWindow *taodonhang)
    {
        ...
        lblT->setText(QCoreApplication::translate("taodonhang", "T\341\273\224NG TI\341\273\200N:", nullptr));
