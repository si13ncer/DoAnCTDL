...
public:
    ...
    void setupUi(QMainWindow *taodonhang)
    {
        ...
        btnLuu->setGeometry(QRect(481, 540, 75, 23));
        QIcon icon;
        ...
        btnHuy->setGeometry(QRect(570, 540, 75, 23));
        QIcon icon1;
        ...
        leditName->setGeometry(QRect(440, 24, 133, 20));
        ...
        leditPhone->setGeometry(QRect(440, 50, 133, 20));
